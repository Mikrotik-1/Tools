(function () {
  ...
  function answer(text) {
    ...
    if (/(نسيت|باسورد|كلمه المرور|password|login|دخول)/.test(clean)) return { text: "تقدر تتصفح الموقع عادي. عند التوليد أو التحميل هتظهر نافذة باسورد الاشتراك؛ اكتب الباسورد المفعّل من الإدارة لإكمال العملية.", links: [{ title: "الاشتراكات", url: "pricing.html" }] };
